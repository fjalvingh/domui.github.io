...
Most DomUI code that works/accepts properties accepts both the "old" String variants but also the typed properties. And [there is an IntelliJ Idea plugin](../../../getting-started/intellij-plugin/index.md) which automatically replaces String references to properties to the equivalent typed properties.
