...
All code in DomUI that accepts a property path as a string also accepts a [typed property](../../building-pages/40-typed-properties/index.md). Using typed properties instead of string constants has many advantages, the most important are:
