...
- The customer property uses a LookupInput2, because it is actually a @ManyToOne relation (parent) of the Invoice class. [This control lets you search for a Customer using a special UI](../the-lookupinput2-component/index.md).
