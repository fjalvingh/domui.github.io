...
- The baseline of the text inside the box **must** align with any baseline of a label before it ([see the form4 layout description](../../domui-component-rules/vertical-form-builder-details/index.md) for details).
