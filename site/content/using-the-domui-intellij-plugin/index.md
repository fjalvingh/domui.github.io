...
Since DomUI 2.0 all code in DomUI that earlier accepted property paths as strings [now also accept typed properties](../using-typed-properties-the-property-annotations-processor/index.md). Using typed properties instead of string constants has many advantages, the most important are:
